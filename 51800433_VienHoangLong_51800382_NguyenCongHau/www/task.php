...
if ($_SESSION['role'] == 2) {
    $tasks = load_task_employee($_SESSION['user']);
}
                                    ...
                                    <div class="card shadow-sm">
                                        <div class="card-body" id="card_item">
                                            <div class="list-group list-group-flush">
                                                <span class="list-group-item"><?= $row['name_task'] ?></span>
                                                <span class="list-group-item"><?= get_fullname($row['name_employee']) ?></span>
                                                <span class="list-group-item">Trạng thái: <?= $row['status'] ?></span>
                                            </div>
                                            <nav class="dropdown">
                                            ...
                                            <nav class="deadline_task">
                                                <div id="statusbar row">
                                                    <a class="progress_task btn <?php echo ($row['status'] == 'In Progress') ? 'bg-primary' : 'bg-default' ?> text-white">IN PROGRESS</a>
                                                    <a class="waiting_task btn <?php echo ($row['status'] == 'Waiting') ? 'bg-warning' : 'bg-default' ?> text-white">WAITING</a>
                                                    <a class="reject_task btn <?php echo ($row['status'] == 'Rejected') ? 'bg-info' : 'bg-default' ?> text-white">REJECTED</a>
                                                    <a class="complete_task btn <?php echo ($row['status'] == 'Completed') ? 'bg-success' : 'bg-default' ?> text-white">COMPLETED</a>
                                                    <a class="cancel_task btn <?php echo ($row['status'] == 'Canceled') ? 'bg-danger' : 'bg-default' ?> text-white">CANCELED</a>
                                                </div>
                                            </nav>
                                            <nav class="check_new">
                                                <?php
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <input type="text" id="id_start_task" name="id_start_task">
