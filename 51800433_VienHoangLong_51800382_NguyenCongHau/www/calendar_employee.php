                ...
                <div class="col-xl-12 col-lg-9">
                    <div class="card shadow mb-4 mt-5">
                        ...
                        <div class="card-header">
                            ...
                            <h6 class="font-weight-bold text-danger">*Note: Tổng ngày nghỉ trong năm là 14 ngày</h6>
                            <div>
                    ...
                    <form id="myForm" method="">
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <input name="" class="form-control" type="text" placeholder="NV01" id="" readonly>
                                    </div>
                                    <div class="col">
                                        <label for="">Họ và tên</label>
                                        <input name="" class="form-control" type="text" placeholder="Viên Hoàng Long" id="" readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <input name="" class="form-control" type="text" placeholder="Nhân viên" id="" readonly>
                                    </div>
                                    <div class="col">
                                        <label for="">Phòng ban</label>
                                        <input name="" class="form-control" type="text" placeholder="CNTT" id="" readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <input name="" class="form-control" type="text" placeholder="9 ngày" id="" readonly>
                                    </div>
                                    <div class="col">
                                        <label for="">Đã sử dụng</label>
                                        <input name="" class="form-control" type="text" placeholder="5 ngày" id="" readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input name="" class="form-control" type="date" id="">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="" name="" rows="4" class="form-control" placeholder="Thêm lí do nghỉ"></textarea>
                            </div>
                        </div>
                        <div class="modal-footer pull-left">
                            <button type="button" class="btn br-color" data-dismiss="modal">Cancel</button>
                            <button type="submit" class="btn br-color">Submit</button>
                        </div>
                    </form>
                </div>
            </div>
